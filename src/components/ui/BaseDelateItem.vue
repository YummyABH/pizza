...
<template>
  ...
  ></div>
  <div
    :class="isOpen ? 'left-1/2' : '-right-full'"
    class="z-50 fixed p-6 transition duration-150 rounded-lg border border-gray-700 transform -translate-1/2 top-1/2 max-w-110 w-full bg-gray-800"
  >
    <div class="relative w-full h-full text-center">
      ...
      <div class="mb-2 text-lg text-white">Удалить {{ name }}</div>
