...
<template>
  <div class="w-screen pl-70 flex justify-self-end text-white">
    <div class="mx-7 px-20 w-full p-5 rounded-2xl">
      ...
      <div class="bg-[#111827] rounded-xl p-5 w-full overflow-x-scroll">
        <div class="min-w-200 grid grid-cols-7 w-full justify-between gap-x-3">
          ...
          >
            ...
            <div
              @click.stop
              class="col-span-7 px-5 py-7 grid grid-cols-3 gap-4 bg-[#6760c4]"
