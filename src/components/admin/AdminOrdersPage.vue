      ...
      <div class="max-lg:hidden bg-[#111827] rounded-xl p-5 max-w-full ">
        <div class=" grid grid-cols-7 max-2xl:grid-cols-14 w-full justify-between gap-x-3">
          <div class="grid grid-cols-subgrid max-2xl:col-span-14 col-span-7 border-b border-t">
            <div class="flex px-5 max-2xl:col-start-1 max-2xl:col-span-1 py-3 justify-self-center w-max">Номер</div>
            <div class="flex px-5 max-2xl:col-start-2 max-2xl:col-span-1 py-3 justify-self-center w-max">Имя</div>
            <div class="flex px-5 max-2xl:col-start-4 max-2xl:col-span-2 py-3 justify-self-center w-max">Дата заказа</div>
            <div class="flex px-5 max-2xl:col-span-5 max-2xl:col-start-6 py-3 justify-self-center w-max">Адрес</div>
            <div class="flex px-5 max-2xl:col-span-2 max-2xl:col-start-11 py-3 justify-self-center w-max">Статус</div>
            <div class="flex px-5 max-2xl:col-span-1 max-2xl:col-start-13 py-3 justify-self-center w-max">Сумма</div>
            <div class="flex px-5 max-2xl:col-span-2 py-3 max-2xl:col-start-14 justify-self-center w-max"></div>
          </div>
          <OrderTableItem
          ...
          >
            ...
            >
              <div class="col-span-3 max-2xl:col-span-2 gap-x-3 grid grid-cols-8 rounded-xl bg-[#1b233a] px-5 py-3">
